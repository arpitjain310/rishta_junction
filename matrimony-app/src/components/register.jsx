...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post("http://rishtajunction.com/api/register", formData);
  ...
  const handleOtpVerification = async () => {
    ...
    try {
      const response = await axios.post("http://rishtajunction.com/api/verify_otp_and_register", {
